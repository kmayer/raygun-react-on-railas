Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "raygun_react_on_rails_#{Rails.env}"
  ...
  # (e.g. sending email).
  config.action_mailer.default_url_options = { host: ENV.fetch("HOSTNAME", "raygun-react-on-rails.herokuapp.com") }
